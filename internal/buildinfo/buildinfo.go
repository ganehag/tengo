...
//
//	go build -ldflags "-X github.com/d5/tengo/v2/internal/buildinfo.version=v2.x.y"
package buildinfo
...
//
//	v2.17.0                                   tagged release, clean
//	v2.17.0 (dirty)                           tagged release, local modifications
//	v2.16.0-0.20260424075157-b249db11b830     untagged build, clean
